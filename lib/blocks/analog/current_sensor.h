...
// class CurrentDriver {
// private:
//     Filter_LPF filtA, filtB, filtC, filtD;  // Instance of low-pass filter for smoothing voltage measurements
...
//      */
//     CurrentDriver(const ChCurrentNZ& CurrentRaw,
//                   const uint8_t& k_filter,
//                   const VoltageMV max_sensor_current,
//                   const bool direction)
//         : MAX_VOLTAGE_MV(max_sensor_current),
//           dir(direction),
//           filtA(CurrentRaw[0], k_filter),
//           filtB(CurrentRaw[1], k_filter),
//           filtC(CurrentRaw[2], k_filter),
//           filtD(CurrentRaw[3], k_filter) {}  // Initialize maximum voltage and filter with raw voltage and filter constant
